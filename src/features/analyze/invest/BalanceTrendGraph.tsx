...
export default function BalanceTrendGraph({
  BalanceTrendData,
}: {
  BalanceTrendData: BalanceTrendGraphProps[];
}) {
  ...
  return (
    ...
    >
      <div
        className={`relative`}
        style={{ width: getWidthClass(processedData.length), height: "100%" }}
      >
        ...
        <div
          className="h-[15%] ml-32 flex gap-4 text-[0.7rem]"
