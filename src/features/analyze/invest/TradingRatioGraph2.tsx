...
import { type TradingRatioGraph2Props } from "./types";
...
export default function TradingRatioGraph2({ TradingRatioData }: { TradingRatioData: TradingRatioGraph2Props[] }) {
    ...
    <div className="w-[calc(100%_+_1rem)] h-80 -ml-6 text-sm">
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        <AreaChart data={processedData} margin={{ top: 40, right: 0, left: 0, bottom: 0 }}>
          ...
          <Area dataKey="highSellRatio" name="고위험" stackId="real" fill="#78D335" stroke="#78D335" />
          <Area dataKey="midSellRatio" name="중위험" stackId="real" fill="#1DB3FB" stroke="#1DB3FB" />
          <Area dataKey="lowSellRatio" name="저위험" stackId="real" fill="#C57CF0" stroke="#C57CF0" />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
